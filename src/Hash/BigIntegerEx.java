...
public class BigIntegerEx {
    ...
    public BigIntegerEx(int endian, BigInteger base) {
        ...
        if (endian == LITTLE_ENDIAN)
            ...
            this.bigInteger = new BigInteger(reverseArray(base.toByteArray(),
                    BIGINT_SIZE));
    }
    ...
    public BigIntegerEx modPow(BigIntegerEx exponent, BigIntegerEx m) {
        return new BigIntegerEx(endian, getBigInteger().modPow(
                exponent.getBigInteger(), m.getBigInteger()));
    }
    ...
    public BigIntegerEx subtract(BigIntegerEx a) {
        return new BigIntegerEx(endian, getBigInteger().subtract(
                a.getBigInteger()));
    }

    public BigIntegerEx multiply(BigIntegerEx a) {
        return new BigIntegerEx(endian, getBigInteger().multiply(
                a.getBigInteger()));
    }
